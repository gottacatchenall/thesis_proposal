...
of communities, \(f\) could be Lotka-Voltera, Holling-Type-II or
...
given size. Further it then proposes a method for optimizing the spatial
...
connected in the MST. The primary reason for doing this is the cut down
the size of the solution space to enable quicker convergence, although
the final software that implements this algorithm will enable
