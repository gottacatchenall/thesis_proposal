...
\tightlist
\item
  we got a tree and SDMs. See appendix figure.
\end{enumerate}
...
the efficacy of interaction detection given a set of observation points
...
answer. Models for inferring corridor locations have been developed, but
...
resistance in an existing landscape from a derived resistance surface
(Peterman 2018).
