...
(Strydom \emph{et al.} 2021b), and some forms are inherently more
``forecastable'' than others (Beckage \emph{et al.} 2011; Chen \emph{et
al.} 2019; Pennekamp \emph{et al.} 2019). The initial success of these
...
depending on who you ask), became the foundation for mathematical models
in ecology.
