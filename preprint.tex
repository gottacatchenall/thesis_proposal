...
methods. We need a software library to generate synthetic data from a
\emph{known} set of mechanisms and parameters to test our methods for
parameter inference and forecasting on a system with \emph{known}
